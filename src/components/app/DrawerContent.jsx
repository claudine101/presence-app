    ...
    return (
        <View style={styles.drawerContent}>
            ...
            <DrawerContentScrollView style={styles.drawerScroller}>
                ...
                {user.ID_PROFIL == 9 || user.ID_PROFIL == 11 ? <TouchableNativeFeedback useForeground background={TouchableNativeFeedback.Ripple(COLORS.handleColor)} onPress={() => handlePress('AllVolumeRecusChefEquiScreen')}>
