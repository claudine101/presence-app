...
/**
 * Screen pour afficher les volumes reenvoyez chez agent sup aille scanning
 * @author Vanny Boy <vanny@mediabox.bi>
 * @date 4/9/2023
 * @returns 
 */

export default function AllVolumeReenvoyerRecusScreen() {
        ...
        //fonction pour recuperer les volumes reenvoyer
