...
/**
 * Screen pour afficher les folios reenvoyez bien traitees
 * @author Vanny Boy <vanny@mediabox.bi>
 * @date 4/9/2023
 * @returns 
 */

export default function FoliosReenvoyezTraitesScreen() {
        ...
        useFocusEffect(useCallback(() => {
                (async () => {
                        try {
                                setLoading(true)
                                const fol = await fetchApi(`/scanning/retour/agent/reenvoyez/equipe/retour/bien/reconcilier`)
