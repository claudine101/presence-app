                ...
                <>
                        ...
                        <View style={styles.container}>
                                ...
                                <ScrollView>
                                        ...
                                        {pvs?.result?.check?.length == details.length ?
                                                <View style={styles.selectContainer}>
                                                        <View style={{ width: '100%' }}>
                                                                ...
                                                                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                                                        ...
                                                                        <Text style={styles.selectedValue}>
                                                                                {multiFolios?.length} Validé{multiFolios.length > 1 && 's'}
                                                                        </Text>
                                                                </View>
                                        ...
                                        {pvs?.result?.check?.length == details.length ? <TouchableOpacity onPress={onTakePicha}>
                                ...
                                {pvs?.result?.check?.length == details.length ? <TouchableWithoutFeedback
                                        disabled={!isValidAdd()}
