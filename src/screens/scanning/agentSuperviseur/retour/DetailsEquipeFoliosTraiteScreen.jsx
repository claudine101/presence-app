...
import { Ionicons, MaterialCommunityIcons, MaterialIcons, FontAwesome5, Fontisto, Feather } from '@expo/vector-icons';
                                                        ...
                                                        <View style={styles.content}>
                                                                ...
                                                                {folio?.folios?.length > 0 ? <View style={styles.selectContainer}>
                                                                        ...
                                                                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                                                                ...
                                                                                {/* <Text style={styles.selectedValue}>
                                                                                        {folio?.folios?.length} Scanné{folio?.folios.length > 1 && 's'}
                                                                                </Text> */}
                                                                        </View>
