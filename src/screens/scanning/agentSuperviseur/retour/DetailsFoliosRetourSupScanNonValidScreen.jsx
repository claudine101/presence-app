...
/**
 * Screen pour afficher les details des folios reconcilier et non valide par chef plateau
 * @author Vanny Boy <vanny@mediabox.bi>
 * @date 30/8/2023
 * @returns 
 */

export default function DetailsFoliosRetourSupScanNonValidScreen() {
        ...
        useFocusEffect(useCallback(() => {
                (async () => {
                        try {
                                ...
                                const res = await fetchApi(`/scanning/retour/agent/equipe/pvs/retour/nonVilid`, {
                                        method: "POST",
                                        body: form
                                })
                                setPvs(res)
