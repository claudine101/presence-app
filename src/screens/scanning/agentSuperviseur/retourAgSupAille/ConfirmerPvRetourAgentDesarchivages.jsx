...
export default function ConfirmerPvRetourAgentDesarchivages(){
        ...
        const submitDesarchivages = async () => {
                try {
                        setLoadingData(true)
                        ...
                        console.log(form)
                        const volume = await fetchApi(`/scanning/retour/agent/desarchivages/${id}`, {
                                method: "PUT",
                                body: form
                        })
                        navigation.goBack()
                        ...
                        <View style={styles.container}>
                                ...
                                <ScrollView>
                                        ...
                                        <TouchableOpacity style={styles.selectContainer} onPress={openEquipeModalize}>
                                                <View>
                                                        <Text style={styles.selectLabel}>
                                                                Selectioner un agent desarchivage
                                                        </Text>
                                                        <View>
                                                                <Text style={styles.selectedValue}>
