...
/**
 * Screen pour afficher les volumes qu'un agent superviseur aille recus
...
export default function AllSuperviseurAileScanVolumeScreen() {
        ...
        useFocusEffect(useCallback(() => {
                (async () => {
                        try {
                                setLoading(true)
                                const res = await fetchApi('/scanning/retour/agent/allVolume/supAilleScanning')
