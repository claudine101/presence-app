...
/**
 * Screen pour afficher le details de volumes lors de retours chez un agent superviseur archives
...
export default function DetailsClickAgentSupArchiveVolumeScreen() {
                        ...
                        {details.map((detail, index) => {
                                return (
                                        <TouchableOpacity style={styles.cardDetails} key={index}
                                                onPress={()=>navigation.navigate("ConfirmerPvRetourAgentDesarchivages", {detail:detail})}
                                        >
