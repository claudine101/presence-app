...
{}
                                                ...
                                                <View style={styles.folio}>
                                                    <View style={styles.folioLeftSide}>
                                                        <View style={styles.folioImageContainer}>
                                                            {heure < heureCible || (heure === heureCible && minute < minuteCible) ? (
                                                                <Image source={require("../../../assets/images/presence.png")} style={styles.folioImage} />


                                                            ) : (
                                                                <Image source={require("../../../assets/images/retard.png")} style={styles.folioImage} />
            ...
            <View style={[styles.amountChanger]}>
