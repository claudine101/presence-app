...
export default function SelectFolioAgentScreen() {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const res = await fetchApi(`/uploadEDMRS/folio/agent_upload`, {
                method: 'POST',
                body: form
            })
        ...
        <>
            ...
            <View style={styles.container}>
                ...
                <ScrollView style={styles.inputs}>
                    ...
                    <View style={styles.selectContainer} onPress={openFlashModalize}>
