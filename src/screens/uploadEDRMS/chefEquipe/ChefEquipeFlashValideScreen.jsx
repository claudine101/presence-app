...
export default function ChefEquipeFlashValideScreen() {
    ...
    const fetchFlash = async () => {
        try {
            const res = await fetchApi(`/uploadEDMRS/folio/flashs?precision=valides`)
    ...
    const handleFlashPress = flashs => {
        navigation.navigate("SelectFolioAgentScreen", { flashs })
    }
    return (
        <>
