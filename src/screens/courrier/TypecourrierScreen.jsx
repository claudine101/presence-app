...
const ListHeader = ({ handleSocietePress, selectedTypecourrier, newTypecourrier,previousRouteName }) => {
    ...
    return (
        <View style={styles.listHeader}>
            ...
            <TouchableNativeFeedback onPress={() => navigation.navigate("NewTypeCourrierScreen", { newTypecourrier, previousRouteName, ...route.params })}>
...
export default function TypecourrierScreen() {
    const navigation = useNavigation()
    const route = useRoute()
