...
export default function AgentSupRetourneScreen() {
        ...
        useFocusEffect(useCallback(() => {
                (async () => {
                        try {
                                setLoading(true)
                                const res = await fetchApi('/preparation/folio/agentSupAileReValides')
        ...
        const handleAgentsPress = (volume, mailleNoTraite) => {
                navigation.navigate("NewAgentSupAIlleScanScreen", { volume: volume, id: volume.ID_VOLUME, mailleNoTraite: mailleNoTraite })
        }
                                                                        ...
                                                                        <>
                                                                                {loading ? <View style={{ flex: 1, alignContent: 'center', alignItems: 'center', justifyContent: 'center' }}>
                                                                                        ...
                                                                                        <TouchableNativeFeedback useForeground background={TouchableNativeFeedback.Ripple(COLORS.handleColor)}
                                                                                                onPress={() => handleAgentsPress(folio.volume, folio.mailleNoTraite)}
                                                                                        >
