...
export default function AgentPreparationFolioRetourneScreen() {
        const navigation = useNavigation()
        const [allDetails, setAllDetails] = useState([])
        const [loading, setLoading] = useState(false)
        const [header, setHeader] = useState("Agents préparations")
        ...
        useFocusEffect(useCallback(() => {
                (async () => {
                        try {
                                setLoading(true)
                                const res = await fetchApi('/preparation/folio/agentRetourne')
