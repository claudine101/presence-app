 ...
 * @returns 
 */
export default function AllVolumeDesarchiveSreen() {
    ...
    useFocusEffect(useCallback(() => {
        (async () => {
            try {
                setLoading(true)
                const vol = await fetchApi(`/preparation/volume/desarchives`)
    ...
    return (
        <>
            <AppHeader title='Volumes désarchivés' />
            {
                                                        ...
                                                        <View style={{ marginTop: 10, marginHorizontal: 5, overflow: 'hidden', borderRadius: 8 }}>
                                                            <View style={styles.folio}>
                                                                <View style={styles.folioLeftSide}>
                                                                    ...
                                                                    <Text style={styles.folioSubname}>Superviseur archive: { volume.traitant.NOM } { volume.traitant.PRENOM }</Text>
