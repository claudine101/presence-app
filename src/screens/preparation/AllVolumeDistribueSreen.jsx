...
import { StyleSheet, Text, View, Image, ActivityIndicator, FlatList, TouchableNativeFeedback } from "react-native";
 ...
 * @returns 
 */
export default function AllVolumeDistribueSreen() {
    ...
    useFocusEffect(useCallback(() => {
        (async () => {
            try {
                setLoading(true)
                const vol = await fetchApi(`/preparation/volume/distribues`)
    ...
    return (
        <>
            <AppHeader title='Volumes distribués' />
                                                    ...
                                                    <View style={styles.folio}>
                                                        <View style={styles.folioLeftSide}>
                                                            ...
                                                            <View style={styles.folioDesc}>
                                                                ...
                                                                <Text style={styles.folioSubname}>Superviseur aile: {volume.traitant.NOM} {volume.traitant.PRENOM}</Text>
                                                                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', flex: 1 }}>
                                                                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                                        <AntDesign name="calendar" size={20} color="#777" />
                                                                        <Text style={[styles.folioSubname, { marginLeft: 3 }]}>{moment(volume?.DATE_INSERTION).format('DD/MM/YYYY HH:mm')}
                                                                        </Text>
                                                                    </View>
                                                                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
