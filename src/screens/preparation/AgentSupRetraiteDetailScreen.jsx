...
export default function AgentSupRetraiteDetailScreen() {
        ...
        useFocusEffect(useCallback(() => {
                (async () => {
                        try {
                                ...
                                form.append('AGENT_SUP_AILE', agent.USERS_ID)
                                const res = await fetchApi(`/preparation/folio/getPvAgentSupAILE`, {
                                        method: "POST",
                                        body: form
                                })
                                setPvs(res)
