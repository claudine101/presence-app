...
export default function NewRemettantSortantScreen() {
    ...
    const{newRemettant,returnkey,newexpediteur,inEdit,courrier}=route.params
    // console.log(inEdit)
    ...
    const societeselect = () => {
        navigation.navigate('SocieteSortantScreen',{
            ...
            previousRouteName:"NewRemettantSortantScreen"
        })
    ...
    const enregistrement = () => {
        ...
        inEdit ?
        navigation.navigate("UpdateCourrierSortantScreen",{
            [returnkey]:{
                ID_REMETTANT:"new",
                NOM:data.nom,
                PRENOM:data.prenom,
                ...
                <View style={styles.header}>
                    <View style={styles.exiitSearch}>
                        ...
                        {returnkey=="expediteur"?<View style={styles.headerBtn}>
                            <Text style={styles.Title}>Nouveau destinataire</Text>
                        </View>:
                        <View style={styles.headerBtn}>
