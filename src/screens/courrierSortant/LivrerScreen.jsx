...
/**
 * Screen pour  livrer   un  courrier
 * @author NDAYISABA Claudine <claudine@mediabox.bi>
 * @date 08/05/2023 à 20:29
 * @returns 
 */

export default function LivrerScreen() {
    ...
    const enregistrement = async () => {
        ...
        try {
            ...
            const res = await fetchApi(`/courrier/courrier_entrants/livrer`, {
                method: 'POST',
                body: form
            })
        ...
        <>
            ...
            <View style={styles.container}>
                <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, marginTop: StatusBar.currentHeight }}>
                    ...
                    <Text style={styles.Title}>Livrer un courrier</Text>
                </View>
