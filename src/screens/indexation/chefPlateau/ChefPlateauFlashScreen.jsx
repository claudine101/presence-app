...
export default function ChefPlateauFlashScreen() {
          ...
          const fetchFlash = async () => {
                    try {
                              const res = await fetchApi(`/indexation/flashs/chef_plateau`)
          ...
          return (
                    <>
                              ...
                              {loading ? <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                                        ...
                                        {!loading && flashs.length > 0 ? <Text style={styles.title}>Dossiers sans agents d'indexation</Text> : null}
