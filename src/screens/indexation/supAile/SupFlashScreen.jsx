...
export default function SupFlashScreen() {
          ...
          const fetchFlash = async () => {
                    try {
                              const res = await fetchApi(`/indexation/flashs/sup_aile_indexation`)
          ...
          return (
                    <>
                              ...
                              {loading ? <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                                        ...
                                        {flashs.length > 0 ? <Text style={styles.title}>Clés des dossiers classés</Text> : null}
