...
export default function SelectFlashAgentSupScreen() {
        ...
        const handleSubmit = async () => {
                try {
                        ...
                        navigation.navigate("IndexationChefEquipeFolioScreen", { noSelectItems: "terminer" })
                        ...
                        <View style={styles.container}>
                                ...
                                <ScrollView style={styles.inputs}>
                                        ...
                                        <TouchableOpacity style={styles.selectContainer} onPress={openFlashModalize}>
                                                ...
                                                <Text style={styles.selectedValue}>
                                                        {data.flash ? data.flash.NOM_FLASH : 'Cliquer pour choisir le support '}
                                                </Text>
                                        </TouchableOpacity>
                                ...
                                {loadingFlashs ? null :
                                        <View style={styles.modalContainer}>
                                                <View style={styles.modalHeader}>
                                                        <Text style={styles.modalTitle}>Sélectionner le support  de stockage</Text>
                                                </View>
                                                {flashs?.result?.length == 0 ? <View style={styles.emptyContainer}>
                                                                                        ...
                                                                                        <View style={styles.listItem}>
                                                                                                <View style={styles.listItemDesc}>
                                                                                                        ...
                                                                                                        <View style={styles.listNames}>
                                                                                                                ...
                                                                                                                <Text style={styles.listItemSubTitle}>{flash.NOM_FLASH}</Text>
                                                                                                        </View>
                                                                                                </View>
