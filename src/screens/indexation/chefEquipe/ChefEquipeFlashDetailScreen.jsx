...
export default function ChefEquipeFlashDetailScreen() {
    ...
    useFocusEffect(useCallback(() => {
        (async () => {
            try {
                ...
                console.log(res.result.FlashFoliosIndexe)
            } catch (error) {
                console.log(error)
            } finally {
                setLoading(false)
    ...
    const handleSubmitRetour = async () => {
        try {
            ...
            form.append("ID_FLASH_INDEXE", flashDetail.ID_FLASH)
    ...
    return (
        <>
            ...
            <View style={styles.container}>
                ...
                {flashDetail?.FlashFoliosIndexe.length > 0 ? <View style={styles.actions}>
